...
--
-- Host: localhost
-- Generation Time: Dec 23, 2021 at 01:13 PM
...
--
-- Database: `detection_of_phishing_websites`
--
CREATE DATABASE IF NOT EXISTS `detection_of_phishing_websites` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `detection_of_phishing_websites`;
...
INSERT INTO `remote_user_detecting_type` (`id`, `Url_Text`, `Prediction`) VALUES
(1, 'www.vdacs.virginia.gov/marketnews/', 'Non Phishing'),
(2, 'www.frosinonenascosta.it/google.com', 'Phishing'),
(7, 'lingshc.com/old_aol.1.3/?Login=&amp;Lis=10&amp;LigertID=1993745&amp;us=1', 'Phishing'),
(8, 'home.comcast.net/~cfallows1/ISAPIdllCustomerSupport&ambaybuyerprotectionpoliciesindex4.html.draft', 'Phishing'),
(9, 'esxcc.com/js/index.htm?us.battle.net/login/en/?ref=mtnyfgjus.battl%/nat/d3/en/addÃ¥x&,10Â´Ã¨1Â²Â°,0.0Â¬0Â¶7Â©Ã®Â¼??a4Â­Ã¼-,+n\\ÃšÃ¡iWÂ´>4Ã»Âš3l|ÂžÃ‚Ãº_Ã™Â·XÂ kMÃ´Ã®}!ipÂ—Â«Ã·p7%Â™Ã˜ÂšrÃ€Â”ÃŸW$Â‰ÃµÂ·x<XÃ‡Â©CÃˆ\\Ã²b', 'Phishing'),
(10, 'www.naturalhub.com/grow_meat_breeds_cattle_small.htm', 'Non Phishing'),
(12, 'web-fill.tk/go/?afid=51', 'Phishing'),
(13, 'scaner-tfeed.tk/go/?afid=96', 'Phishing'),
(14, 'update.onescan.co.kr/setupa/onescansetup.exe', 'Phishing'),
(15, 'tools.ietf.org/html/rfc469', 'Non Phishing'),
(16, 'www.sisimtel.com.mx/ecommerce/images/.../freebank/myposte/index.html?MfcISAPICommand=SignInFPP&UsingSSL=1&email=&userid=', 'Phishing'),
(17, 'www.greattrailrunsinutah.com/s/www.paypal.it_service-security_confermation/it/Processing1.php?cmd=_Processing&dispatch=5885d80a13c0db1fb6947b0aeae66fdbfb2119927117e3a6f876e0fd34af43657bb4d8e58feeb4bd35122e2d3cb6916d7bb4d8e58feeb4bd35122e2d3cb6916d', 'Phishing'),
(18, 'ÂŠRybjUxÃ™Ã£l5Â»7Ã†E%ÃÃ”k+h|U\Z+Ã½kÂ©Ã¬Ã‰Â”Â½Â“Ã†q]Ã¢FÂ·ÂžÃµÃÂ¢w)Ã«AÂ·Ã§Â“Â°Âš{t*m!Â¦2', 'Phishing'),
(19, 'www.118bm.com/images/?us.battle.net/login/en/?ref=dwfgmsdus.battle.net/d3/en/index&amp;app=com-d3', 'Phishing'),
(20, 'woodstonmanor.tripod.com/Angus.htm', 'Non Phishing');
...
(58, 'Naive Bayes', '94.02023919043239'),
(59, 'SVM', '94.84820607175713'),
(60, 'Logistic Regression', '93.83624655013799'),
(61, 'Decision Tree Classifier', '93.10027598896045'),
(62, 'Random Forest Classifier', '94.48022079116836'),
(63, 'SGD Classifier', '95.67617295308187');
...
(12, 'Phishing', '73.33333333333333'),
(13, 'Non Phishing', '26.666666666666668');
